...
var _replacer = require(/* eslint-disable @typescript-eslint/quotes */ "../internal/replacer");
var _codepoints = require("../internal/codepoints");
...
function decodeHTMLEntitiesDeep(input) {
    ...
    if ((typeof input === "undefined" ? "undefined" : _type_of._(input)) === 'object') {
