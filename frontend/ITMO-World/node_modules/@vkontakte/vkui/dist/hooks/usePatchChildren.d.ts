 ...
 * @private
 */
export declare const usePatchChildren: <ElementType extends HTMLElement = HTMLElement>(children?: ChildrenElement<ElementType>, injectProps?: InjectProps<ElementType>, externRef?: React.Ref<ElementType>) => [React.MutableRefObject<ElementType | null>, ChildrenElement<ElementType> | undefined];
export {};
