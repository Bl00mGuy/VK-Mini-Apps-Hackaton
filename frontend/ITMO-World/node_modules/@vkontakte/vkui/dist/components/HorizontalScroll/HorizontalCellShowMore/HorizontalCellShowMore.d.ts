...
export declare const HorizontalCellShowMore: ({ className, style, getRef, getRootRef, compensateLastCellIndent, height, size, children, centered, ...restProps }: HorizontalCellShowMoreProps) => React.ReactNode;
