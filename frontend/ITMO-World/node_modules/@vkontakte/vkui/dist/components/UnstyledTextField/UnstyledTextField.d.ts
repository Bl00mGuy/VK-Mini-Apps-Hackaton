...
export interface UnstyledTextFieldAsInputProps extends UnstyledTextFieldBaseProps, React.InputHTMLAttributes<HTMLInputElement>, HasRootRef<HTMLInputElement> {
    as: 'input';
}
export interface UnstyledTextFieldAsTextareaProps extends UnstyledTextFieldBaseProps, React.TextareaHTMLAttributes<HTMLTextAreaElement>, HasRootRef<HTMLTextAreaElement> {
    as: 'textarea';
}
export type UnstyledTextFieldProps = UnstyledTextFieldAsInputProps | UnstyledTextFieldAsTextareaProps;
/**
 ...
 * @since 6.1.0
 */
export declare const UnstyledTextField: ({ as, noPadding, className, ...restProps }: UnstyledTextFieldProps) => React.ReactNode;
//# sourceMappingURL=UnstyledTextField.d.ts.map