 ...
 */
export declare const ModalPage: ({ children, header, size: sizeProp, onOpen, onOpened, onClose, onClosed, settlingHeight, dynamicContentHeight, getModalContentRef, nav, id: idProp, hideCloseButton, height, modalContentTestId, modalDismissButtonTestId, getRootRef, preventClose, ...restProps }: ModalPageProps) => React.ReactNode;
