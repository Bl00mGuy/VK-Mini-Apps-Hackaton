 ...
 */
export declare const WriteBar: ({ className, style, before, inlineAfter, after, getRootRef, getRef, onHeightChange, shadow, onChange, ...restProps }: WriteBarProps) => React.ReactNode;
