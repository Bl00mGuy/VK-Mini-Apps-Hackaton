...
export interface TooltipBaseProps extends Omit<HTMLAttributesWithRootRef<HTMLDivElement>, 'children'> {
    /**
 ...
 * @private
 */
export declare const TooltipBase: ({ appearance, arrowProps, ArrowIcon, text, header, maxWidth, closeIconLabel, onCloseIconClick, className, ...restProps }: TooltipBaseProps) => React.ReactNode;
