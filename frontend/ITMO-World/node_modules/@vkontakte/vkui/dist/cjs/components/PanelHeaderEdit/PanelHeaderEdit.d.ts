 ...
 */
export declare const PanelHeaderEdit: ({ isActive, editLabel, doneLabel, ...restProps }: PanelHeaderEditProps) => React.ReactNode;
//# sourceMappingURL=PanelHeaderEdit.d.ts.map