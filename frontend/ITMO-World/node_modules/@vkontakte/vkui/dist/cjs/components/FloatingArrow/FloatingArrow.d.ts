 ...
 * @private
 */
export declare const FloatingArrow: ({ offset, isStaticOffset, coords, iconStyle, iconClassName, placement, getRootRef, Icon, ...restProps }: FloatingArrowProps) => React.ReactNode;
