import type { Placement, UseFloatingData, UseFloatingMiddleware, UseFloatingRefs } from '../types/common';
...
} & Pick<React.DOMAttributes<T>, 'onMouseOver' | 'onMouseLeave' | 'onClick' | 'onAnimationStart' | 'onAnimationEnd'>;
