 ...
 */
export declare function convertFloatingDataToReactCSSProperties(strategy: FloatingPositionStrategy, x: UseFloatingData['x'], y: UseFloatingData['y'], initialWidth?: React.CSSProperties['width'] | null, middlewareData?: UseFloatingData['middlewareData']): React.CSSProperties;
